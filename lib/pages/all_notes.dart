...
class AllNotes extends ConsumerStatefulWidget {
  const AllNotes({super.key});

  @override
  ConsumerState<AllNotes> createState() => _FavoritesPageState();
}

class _FavoritesPageState extends ConsumerState<AllNotes> {
